package com.trilobyte.superheros.aspect;
...
public class MonitorAspect {
  ...
  @Pointcut("within(@com.trilobyte.superheros.aspect.annotation.Monitor *)")
  private void beanAnnotatedWithMonitor() { //
  }

  @Pointcut("@annotation(com.trilobyte.superheros.aspect.annotation.Monitor)")
