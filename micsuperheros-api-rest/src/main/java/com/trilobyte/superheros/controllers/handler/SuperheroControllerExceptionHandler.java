...
import com.trilobyte.superheros.dto.ErrorDto;
...
public class SuperheroControllerExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  protected ResponseEntity<Object> handleHttpMessageNotReadable(
    ...
    if (ex.getCause() instanceof PropertyBindingException) {
      ...
      final var ex2 = new ValidacionException();
      final var msg =
   ...
   * {@link ValidacionException}. Non extended the previous classes elements will not be added
   *
   * @param violations lista de {@link ConstraintViolation}, {@link FieldError} u {@link
   *     ObjectError}
   * @return {@link ValidacionException}
   */
  private static ValidacionException toValidacionException(final Collection<?> violations) {
    ...
    for (final Object o : violations) {
      if (o instanceof ConstraintViolation) {
        ...
        final var msg = new ExceptionMessage(t.getMessage());
        ...
        final var msg = new ExceptionMessage(t.getDefaultMessage());
